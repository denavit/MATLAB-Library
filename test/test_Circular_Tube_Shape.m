...
numShapes = length(ShapeData_Round_HSS);

label_aisc = {ShapeData_Round_HSS(:).label};
D = [ShapeData_Round_HSS(:).OD];
t = [ShapeData_Round_HSS(:).tdes];

A_aisc  = [ShapeData_Round_HSS(:).A];
Ix_aisc = [ShapeData_Round_HSS(:).Ix];
Iy_aisc = [ShapeData_Round_HSS(:).Iy];
Sx_aisc = [ShapeData_Round_HSS(:).Sx];
Sy_aisc = [ShapeData_Round_HSS(:).Sy];
rx_aisc = [ShapeData_Round_HSS(:).rx];
ry_aisc = [ShapeData_Round_HSS(:).ry];
Zx_aisc = [ShapeData_Round_HSS(:).Zx];
Zy_aisc = [ShapeData_Round_HSS(:).Zy];
J_aisc  = [ShapeData_Round_HSS(:).J];
...
for i = 1:numShapes
    shape = Circular_Tube_Shape(D(i),t(i));
